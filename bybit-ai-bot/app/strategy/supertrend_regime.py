...
async def evaluate_supertrend_regime(client, symbol: str):
    """
    Estrategia 2: SuperTrend EMA Regime MTF Pro
    """
    try:
        ...
        # Evaluate Long
        if long_setup_armed:
            if (latest_15m['supertrend_dir'] == 1 and
                ...
                latest_15m['adx'] >= 18 and
                latest_15m['ema_200_slope'] > 0 and
                latest_15m['distance_to_ema200'] >= (0.3 * latest_15m['atr']) and
        ...
        # Evaluate Short
        if signal == "NONE" and short_setup_armed:
            if (latest_15m['supertrend_dir'] == -1 and
                latest_15m['close'] < latest_15m['ema_200'] and
                latest_15m['supertrend'] < latest_15m['ema_200'] and
                latest_15m['ema_9'] < latest_15m['ema_200'] and
